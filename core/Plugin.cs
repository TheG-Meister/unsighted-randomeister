...
public class Plugin : BaseUnityPlugin
{
    ...
    public Plugin()
    {
        ...
        this.movementLogger = new MovementLogger("unsighted-randomeister/logs/movement/nodes.tsv", "unsighted-randomeister/logs/movement/edges.tsv", "unsighted-randomeister/logs/movement/states.tsv")
        {
